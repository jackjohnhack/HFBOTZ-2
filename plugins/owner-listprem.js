const { clockString } = require("../../lib/other-function");
...
const handler = async (m, { conn, command, args }) => {
  if ("listpremium" === command) {
    ...
    let premiumTime = db.data.users[m.sender]?.premiumTime || 0,
      prem = db.data.users[m.sender]?.premium || false,
