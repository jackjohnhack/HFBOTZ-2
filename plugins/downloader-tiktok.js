...
const TiktokModule = require("@xct007/tiktok-scraper");
const ora = require("ora");
const chalk = require("chalk");
const { TiktokJs } = require("../../lib/tiktok-js.js");
const { tiktokdl } = require("../../lib/scraper-api.js");
...
let handler = async (m, { command, usedPrefix, conn, text, args }) => {
  let lister = Array.from({ length: 20 }, (_, index) => parseInt(index + 1)),
